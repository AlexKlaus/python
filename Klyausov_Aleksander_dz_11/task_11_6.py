class Stock:
    ...
    def add_equipment(self, equipment, quantity):
        ...
        try:
            ...
            print("Кличество до лжно быть в виде целого числа!")
        else:
    ...
    def give_away(self, equipment, quantity, where):
        ...
        """
        try:
            if self.equipment_in_stock[equipment] and self.equipment_in_stock[equipment] >= int(quantity):
            ...
            print("Кличество должно быть в виде целого числа!")
...
stock.add_equipment(xerox_xr587, 'десять')
stock.add_equipment(printer_a820, 13)
...
stock.give_away(printer_a820, 'три', 'Офис-2')
